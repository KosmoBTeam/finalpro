...
public class SurveyController {
   ...
   //파이차트 json데이터 작업
   @ResponseBody
   @RequestMapping(value="/getPieChartDetail")
   public JSONObject getPieChartDetail() {
      List<SurveyViewVO> list = surveyDao.surveyPieChartView();
   ...
   //막대차트 json데이터 작업
   @ResponseBody
   @RequestMapping(value="/getcolumnChartDetail")
   public JSONObject getcolumnChartDetail() {
      List<SurveyViewVO> list = surveyDao.surveycolumnChartView();
      List<Integer> num = new ArrayList<Integer>();
      List<String> sub = new ArrayList<String>();
      List<Integer> cnt = new ArrayList<Integer>();
      List<String> surveyTitle = new ArrayList<String>();
