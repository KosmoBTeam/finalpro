       ...
       <!-- #header end -->
        ...
        <section id="page-title" class="page-title-parallax page-title-dark" style="padding: 200px 0; background-image: url('http://placehold.it/2000x1333'); background-size: cover; background-position: center center;" data-stellar-background-ratio="0.2">
            ...
            <div class="container clearfix">
                <h1>FAQs</h1>
                <span>Page with Right Sidebar</span>
            </div>
                    ...
                    <div class="postcontent nobottommargin clearfix">
                        <div class="nobottommargin">
                            ...
                            <ul class="iconlist faqlist">
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-1">What are the hours of operation?</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-2">Holiday Hours</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-3">What is the current promotion? Are there any specials?</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-4">Do you offer catering?</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-5">Where will you be building future restaurants?</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-6">Where do I fill out a survey of my visit?</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-7">Where can I get a coupon?</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-8">Do you give back to local organizations?</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-9">Do you offer group discounts?</a></li>
                                <li><i class="icon-chevron-right"></i><a href="#" data-scrollto="#faq-10">Is there a free birthday offer in the restaurant?</a></li>
                            </ul>
