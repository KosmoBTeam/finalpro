   ...
   <div class="container-login100">
      <div class="wrap-login100"
         ...
         <div class="login100-form-title"
            ...
            <span class="login100-form-title-1" style="font-size: 70px;">회
               원 가 입</span>
         </div>
         ...
         <form name="form1" method="post" action="joinMember" id="joinForm"
            ...
            <div class="row" style="margin-bottom: 10px">
               <div class="col-md-6">
                  <label for="template-contactform-name"
                     style="margin-bottom: 10px; font-weight: bold; font-size: 20px">아이디
                     <button type="button" class="btn btn-primary" id="duplicateCheck"
                        onclick="duplicate()"
                        style="background-color: #EAAF22; padding: 2px 2px 2px 2px; margin: 10px; border-color: white; border-radius: 5px;">중복확인</button>
                     <br>
               ...
               <div class="col-md-6">
                  <label for="template-contactform-name"
                     style="font-weight: bold; font-size: 20px; margin-top: 8px; margin-bottom: -3px;">이름</label><br>
            ...
            <div class="row" style="margin-bottom: 10px">
               <div class="col-md-6">
                  <label for="template-contactform-name"
                     style="font-weight: bold; font-size: 20px">비밀번호</label> <br>
               ...
               <div class="col-md-6">
                  <label for="template-contactform-name"
                     style="font-weight: bold; font-size: 20px">비밀번호 확인 </label> <font
            ...
            <div class="row" style="margin-bottom: 10px">
               <div class="col-md-6">
                  <label for="template-contactform-name"
                     style="font-weight: bold; font-size: 20px">전화번호</label><br>
            ...
            <div class="row" style="margin-bottom: 10px">
               <div class="col-md-6">
                  <label for="template-contactform-name"
                     style="font-weight: bold; font-size: 20px; margin-bottom: -10px;">우편번호
                     <button type="button" class="btn btn-primary"
                        onclick="sample2_execDaumPostcode()"
                        style="background-color: #EAAF22; padding: 2px 2px 2px 2px; margin: 10px; border-color: white; border-radius: 5px;">우편번호
                        찾기</button>
               ...
               <div class="col-md-6" style="padding-top: 5px">
                  <label for="template-contactform-name"
                     style="font-weight: bold; font-size: 20px; margin-top: 4px; margin-bottom: -3px;">기본주소</label><br>
                  <input type="text" class="well well-sm" name="ad1"
                     id="sample2_address" size="35" placeholder="기본주소"
                     required="required">
               </div>
            </div>
            ...
            <div class="row" style="margin-bottom: 10px">
               <div class="col-md-6">
                  <label for="template-contactform-name"
                     style="font-weight: bold; font-size: 20px">동,면,읍</label><br>
               ...
               <div class="col-md-6">
                  <label for="template-contactform-name"
                     style="font-weight: bold; font-size: 20px">상세주소</label><br>
