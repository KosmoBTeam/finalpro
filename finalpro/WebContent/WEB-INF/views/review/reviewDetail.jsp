...
<body>
   ...
   <div id="wrapper" class="clearfix"
      style="animation-duration: 1.5s; opacity: 1; width: 1000px;">
      <!-- Page Title
        ============================================= -->
      ...
      <div
         style="text-align: left; font-family: serif; height: 100%; padding: 5%;">
         <img id="page-title" class="page-title-parallax"
            src="${vo.img }"
            style="width: 450px; padding: 0px; height: 300px; background-position: 50% 0px;"
            data-stellar-background-ratio="0.3">
            <div class="entry-overlay-meta">
                            <h2><a href="goHotelDetail?num=2">${vo.title }</a></h2>
                            <ul class="iconlist">
                                <li><i class="icon-calendar3"></i> <strong>일정 : </strong> ${vo.rdate }</li>
                                <li><i class="icon-eye"></i> <strong>조회수 : </strong> ${vo.rdate }</li>
                                <li><i class="icon-map-marker2"></i> <strong>위치 : </strong>${vo.honame}</li>
                                <li><i class="icon-dollar"></i> <strong>예상 경비 : </strong> 157,850원</li>
                            </ul>
                            <a href="#" class="btn button btn-block button-large">RSVP</a>
                        </div>
         <ul class=""
            style="text-align: center; display: inline-block; font-size: 25px; list-style: none; position: absolute; right: 8%; top: 10%;">
            <li>${vo.title }</li>
            <li>여행자 : ${vo.id}<c:if test="${vo.id eq sessionScope['id']}">
         ...
         <div class="single-post nobottommargin"
            style="margin: 5%; text-align: left; height: 500px; padding: 40px;">
            <span style="font-size: 20px; font-family: fantasy;">${vo.detail }</span>
         </div>
         ...
         <div class="postcontent nobottommargin clearfix" style="width: 100%;">
            <form action="goEditReview" method="post" id="repl">
               ...
               <div class="postcontent nobottommargin clearfix"
                  style="width: 100%; margin: 20px; text-align: -webkit-center;">
                  <table style="width: 50%; margin: 0; margin-top: 1%;">
                     <tr>
