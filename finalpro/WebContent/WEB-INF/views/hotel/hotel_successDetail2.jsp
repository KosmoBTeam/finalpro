...
<body class="stretched">
 ...
 <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-3 control-label" style="color: white;">이미지</label>
    <div class="col-sm-9">
      <input type="text" class="form-control" value="${list.img }" id="totalpay" name="totalpay">
    </div>
  </div>
  <div class="form-group">
