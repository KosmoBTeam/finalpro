(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div00","10","0","1786","2060",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("Grid00","990","290","530","326",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("9");
            obj.set_binddataset("reveiw");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"132\"/><Column size=\"132\"/><Column size=\"132\"/><Column size=\"132\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"댓글번호\"/><Cell col=\"1\" text=\"아이디\"/><Cell col=\"2\" text=\"내용요약\"/><Cell col=\"3\" text=\"작성일\"/></Band><Band id=\"body\"><Cell text=\"bind:댓글번호\"/><Cell col=\"1\" text=\"bind:아이디\"/><Cell col=\"2\" text=\"bind:내용요약\"/><Cell col=\"3\" text=\"bind:작성일\"/></Band></Format></Formats>");
            this.Div00.addChild(obj.name, obj);
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","Desktop_screen",1800,1890,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.Div00.move("10","0","1786","2060",null,null);
            	}
            );
            this.addLayout(obj.name, obj);

            //-- Normal Layout : this
            obj = new Layout("screen00","screen00",1080,670,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
